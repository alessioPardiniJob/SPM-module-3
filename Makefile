...
parallel_partitioning_compute_histogram_local_flatarray: directories $(TARGET_PARALLEL_PARTITIONING_COMPUTEHISTOGRAM_LOCAL_FLATARRAY)
parallel_partitioning_compute_histogram_local_threadaffinity: directories $(TARGET_PARALLEL_PARTITIONING_COMPUTEHISTOGRAM_LOCAL_THREADAFFINITY)
